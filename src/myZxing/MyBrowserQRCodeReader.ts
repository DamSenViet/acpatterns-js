 ...
 */
class MyBrowserQRCodeReader {
  /**
   * Creates an instance of MyBrowserQRCodeReader.
   * @param {MyQRCodeReader} [reader=new MyQRCodeReader()] The reader instance to decode the barcode
   * @param {number} [timeBetweenScansMillis=500] the time delay between subsequent successful decode tries
   */
  public constructor(
    protected readonly reader: MyQRCodeReader = new MyQRCodeReader(),
   ...
   */
  public async decodeFromInputVideoDeviceContinuously(deviceId: string | null, videoSource: string | HTMLVideoElement | null, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
   ...
   * @memberOf BrowserCodeReader
   */
  public async decodeFromVideoDevice(deviceId: string | null, videoSource: string | HTMLVideoElement | null, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
   ...
   * @memberOf BrowserCodeReader
   */
  public async decodeFromConstraints(constraints: MediaStreamConstraints, videoSource: string | HTMLVideoElement, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
   ...
   * @memberOf BrowserCodeReader
   */
  public async decodeFromStream(stream: MediaStream, videoSource: string | HTMLVideoElement, callbackFn: MyDecodeContinuouslyCallback) {
   ...
   * @experimental
   */
  public decodeFromVideoContinuously(source: string | HTMLVideoElement | null, url: string | null, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
   ...
   * Decodes something from an image HTML element.
   */
  public decodeFromVideoElementContinuously(source: string | HTMLVideoElement, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
   ...
   * @experimental
   */
  public decodeFromVideoUrlContinuously(url: string, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
  ...
  private async _decodeOnLoadVideoContinuously(videoElement: HTMLVideoElement, callbackFn: MyDecodeContinuouslyCallback): Promise<void> {
    // plays the video
    await this.playVideoOnLoadAsync(videoElement);
    // starts decoding after played the video
   ...
   */
  public decodeContinuously(element: HTMLVideoElement, callbackFn: MyDecodeContinuouslyCallback): void {
...
export default MyBrowserQRCodeReader;